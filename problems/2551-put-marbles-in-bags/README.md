...
🔴 **Difficulty:** Hard &nbsp;|&nbsp; 🏷️ **Topics:** `Array` `Greedy` `Sorting` `Heap (Priority Queue)`
...
*Synced automatically from [LeetCode](https://leetcode.com/problems/put-marbles-in-bags/) · Submission ID: 989400834*
