...
🔴 **Difficulty:** Hard &nbsp;|&nbsp; 🏷️ **Topics:** `Array` `Hash Table` `Binary Search` `Sorting` `Prefix Sum` `Ordered Set`
...
*Synced automatically from [LeetCode](https://leetcode.com/problems/number-of-flowers-in-full-bloom/) · Submission ID: 1072762119*
