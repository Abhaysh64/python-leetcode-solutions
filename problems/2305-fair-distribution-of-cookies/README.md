...
🟡 **Difficulty:** Medium &nbsp;|&nbsp; 🏷️ **Topics:** `Array` `Dynamic Programming` `Backtracking` `Bit Manipulation` `Bitmask`
...
*Synced automatically from [LeetCode](https://leetcode.com/problems/fair-distribution-of-cookies/) · Submission ID: 983871939*
