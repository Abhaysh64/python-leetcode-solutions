...
🟡 **Difficulty:** Medium &nbsp;|&nbsp; 🏷️ **Topics:** `Graph Theory`
...
*Synced automatically from [LeetCode](https://leetcode.com/problems/minimum-number-of-vertices-to-reach-all-nodes/) · Submission ID: 952868317*
