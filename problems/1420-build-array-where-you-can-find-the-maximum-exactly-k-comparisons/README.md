...
🔴 **Difficulty:** Hard &nbsp;|&nbsp; 🏷️ **Topics:** `Dynamic Programming` `Prefix Sum`
...
*Synced automatically from [LeetCode](https://leetcode.com/problems/build-array-where-you-can-find-the-maximum-exactly-k-comparisons/) · Submission ID: 1069222481*
