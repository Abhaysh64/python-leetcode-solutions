...
🟡 **Difficulty:** Medium &nbsp;|&nbsp; 🏷️ **Topics:** `Array` `Math` `Depth-First Search` `Breadth-First Search` `Graph Theory` `Geometry`
...
*Synced automatically from [LeetCode](https://leetcode.com/problems/detonate-the-maximum-bombs/) · Submission ID: 962434198*
