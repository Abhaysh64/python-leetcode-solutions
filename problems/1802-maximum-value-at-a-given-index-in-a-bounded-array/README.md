...
🟡 **Difficulty:** Medium &nbsp;|&nbsp; 🏷️ **Topics:** `Math` `Binary Search` `Greedy`
...
*Synced automatically from [LeetCode](https://leetcode.com/problems/maximum-value-at-a-given-index-in-a-bounded-array/) · Submission ID: 968216597*
