...
🔴 **Difficulty:** Hard &nbsp;|&nbsp; 🏷️ **Topics:** `Hash Table` `String` `Dynamic Programming` `Enumeration`
...
*Synced automatically from [LeetCode](https://leetcode.com/problems/substring-with-largest-variance/) · Submission ID: 991185491*
