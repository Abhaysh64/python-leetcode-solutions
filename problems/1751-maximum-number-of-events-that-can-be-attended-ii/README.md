...
🔴 **Difficulty:** Hard &nbsp;|&nbsp; 🏷️ **Topics:** `Array` `Binary Search` `Dynamic Programming` `Sorting`
...
*Synced automatically from [LeetCode](https://leetcode.com/problems/maximum-number-of-events-that-can-be-attended-ii/) · Submission ID: 994966120*
