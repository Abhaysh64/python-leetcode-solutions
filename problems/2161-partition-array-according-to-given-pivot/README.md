...
🟡 **Difficulty:** Medium &nbsp;|&nbsp; 🏷️ **Topics:** `Array` `Two Pointers` `Simulation`
...
*Synced automatically from [LeetCode](https://leetcode.com/problems/partition-array-according-to-given-pivot/) · Submission ID: 2026399183*
