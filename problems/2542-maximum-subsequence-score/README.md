...
🟡 **Difficulty:** Medium &nbsp;|&nbsp; 🏷️ **Topics:** `Array` `Greedy` `Sorting` `Heap (Priority Queue)`
...
*Synced automatically from [LeetCode](https://leetcode.com/problems/maximum-subsequence-score/) · Submission ID: 962437944*
