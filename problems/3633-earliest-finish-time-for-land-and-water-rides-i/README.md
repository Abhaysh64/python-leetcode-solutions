...
🟢 **Difficulty:** Easy &nbsp;|&nbsp; 🏷️ **Topics:** `Array` `Two Pointers` `Binary Search` `Greedy` `Sorting`
...
*Synced automatically from [LeetCode](https://leetcode.com/problems/earliest-finish-time-for-land-and-water-rides-i/) · Submission ID: 2020443207*
