...
🟡 **Difficulty:** Medium &nbsp;|&nbsp; 🏷️ **Topics:** `Array` `Math` `String` `Matrix`
...
*Synced automatically from [LeetCode](https://leetcode.com/problems/number-of-laser-beams-in-a-bank/) · Submission ID: 1135456574*
