...
🔴 **Difficulty:** Hard &nbsp;|&nbsp; 🏷️ **Topics:** `Graph Theory` `Design` `Heap (Priority Queue)` `Shortest Path`
...
*Synced automatically from [LeetCode](https://leetcode.com/problems/design-graph-with-shortest-path-calculator/) · Submission ID: 1096627455*
