...
🟡 **Difficulty:** Medium &nbsp;|&nbsp; 🏷️ **Topics:** `Array` `Two Pointers` `Heap (Priority Queue)` `Simulation`
...
*Synced automatically from [LeetCode](https://leetcode.com/problems/total-cost-to-hire-k-workers/) · Submission ID: 980199332*
