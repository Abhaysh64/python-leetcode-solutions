...
🟡 **Difficulty:** Medium &nbsp;|&nbsp; 🏷️ **Topics:** `Math` `Tree` `Depth-First Search`
...
*Synced automatically from [LeetCode](https://leetcode.com/problems/number-of-ways-to-assign-edge-weights-i/) · Submission ID: 2029657669*
