...
🟢 **Difficulty:** Easy &nbsp;|&nbsp; 🏷️ **Topics:** `Tree` `Design` `Binary Search Tree` `Heap (Priority Queue)` `Binary Tree` `Data Stream`
...
*Synced automatically from [LeetCode](https://leetcode.com/problems/kth-largest-element-in-a-stream/) · Submission ID: 955981490*
