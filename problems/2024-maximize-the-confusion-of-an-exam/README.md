...
🟡 **Difficulty:** Medium &nbsp;|&nbsp; 🏷️ **Topics:** `String` `Binary Search` `Sliding Window` `Prefix Sum`
...
*Synced automatically from [LeetCode](https://leetcode.com/problems/maximize-the-confusion-of-an-exam/) · Submission ID: 988467946*
