...
🔴 **Difficulty:** Hard &nbsp;|&nbsp; 🏷️ **Topics:** `Array` `Math` `Dynamic Programming` `Game Theory`
...
*Synced automatically from [LeetCode](https://leetcode.com/problems/stone-game-iii/) · Submission ID: 958481237*
