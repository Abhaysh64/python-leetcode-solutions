...
🟡 **Difficulty:** Medium &nbsp;|&nbsp; 🏷️ **Topics:** `Array` `Hash Table`
...
*Synced automatically from [LeetCode](https://leetcode.com/problems/convert-an-array-into-a-2d-array-with-conditions/) · Submission ID: 1134902210*
