...
🟡 **Difficulty:** Medium &nbsp;|&nbsp; 🏷️ **Topics:** `Array` `Hash Table` `Two Pointers` `String` `Dynamic Programming` `Sorting`
...
*Synced automatically from [LeetCode](https://leetcode.com/problems/longest-string-chain/) · Submission ID: 1057206882*
